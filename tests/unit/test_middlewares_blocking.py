...
class TestBlockingMiddleware:
    ...
    @pytest.mark.asyncio
    async def test_non_blocked_user_passes(self, mock_blocklist_backend, mock_handler, mock_message, mock_data):
    ...
    @pytest.mark.asyncio
    async def test_blocked_user_short_circuit(self, mock_blocklist_backend, mock_handler, mock_message, mock_data):
    ...
    @pytest.mark.asyncio
    async def test_extract_user_id_from_message(self, mock_blocklist_backend, mock_handler, mock_data):
    ...
    @pytest.mark.asyncio
    async def test_extract_user_id_from_callback_query(self, mock_blocklist_backend, mock_handler, mock_data):
    ...
    @pytest.mark.asyncio
    async def test_extract_user_id_from_chat(self, mock_blocklist_backend, mock_handler, mock_data):
    ...
    @pytest.mark.asyncio
    async def test_no_user_id_available(self, mock_blocklist_backend, mock_handler, mock_data):
    ...
    @pytest.mark.asyncio
    async def test_blocklist_backend_error(self, mock_blocklist_backend, mock_handler, mock_message, mock_data):
    ...
    @pytest.mark.asyncio
    async def test_handler_error_propagation(self, mock_blocklist_backend, mock_handler, mock_message, mock_data):
    ...
    @pytest.mark.asyncio
    async def test_data_preservation(self, mock_blocklist_backend, mock_handler, mock_message, mock_data):
    ...
    @pytest.mark.asyncio
    async def test_blocked_flag_preservation(self, mock_blocklist_backend, mock_handler, mock_message, mock_data):
    ...
    @pytest.mark.asyncio
    async def test_multiple_events_same_user(self, mock_blocklist_backend, mock_handler, mock_data):
    ...
    @pytest.mark.asyncio
    async def test_different_users(self, mock_blocklist_backend, mock_handler, mock_data):
        ...
        called_user_ids = [call[0][0] for call in mock_blocklist_backend.is_blocked.call_args_list]
    ...
    @pytest.mark.asyncio
    async def test_edge_case_empty_data(self, mock_blocklist_backend, mock_handler, mock_message):
    ...
    @pytest.mark.asyncio
    async def test_edge_case_none_data(self, mock_blocklist_backend, mock_handler, mock_message):
